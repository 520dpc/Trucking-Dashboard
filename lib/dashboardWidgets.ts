...
export const DEFAULT_DASHBOARD_LAYOUT: WidgetLayoutConfig[] = [    // Array describing where each widget should appear by default.
  ...
  { id: "cashflowKpi",        x: 9,  y: 0, w: 3, h: 2 },           // Net cashflow in the top-left.
  { id: "revenueKpi",         x: 0,  y: 0, w: 3, h: 2 },           // Revenue next to cashflow.
  { id: "expensesKpi",        x: 0,  y: 13, w: 12, h: 3 },           // Expenses in the first row.
  { id: "netProfitKpi",       x: 6,  y: 0, w: 3, h: 2 },           // Net profit at the top-right.

  // ───────── MIDDLE KPI ROW (2 rows tall, 4 tiles) ─────────
  { id: "avgRpmCard",         x: 0,  y: 2, w: 4, h: 2 },           // Rate per mile on the left of row 2.
  { id: "fuelOverviewCard",   x: 3,  y: 0, w: 3, h: 2 },           // Fuel % of revenue next to RPM.
  { id: "loadsCompletedCard", x: 6,  y: 10, w: 12, h: 3 },           // Loads completed in row 2.
  { id: "milesCard",          x: 8,  y: 2, w: 4, h: 2 },           // Total miles at the right of row 2.

  // ───────── FOLLOW-UP / RELATIONSHIP ROW (3 rows tall, 3 tiles) ─────────
  { id: "staleCustomersCard", x: 0,  y: 4, w: 6, h: 3 },           // Stale customers widget spanning 4 columns.
  { id: "staleProspectsCard", x: 6,  y: 4, w: 6, h: 3 },           // Stale prospects widget in the middle.
  { id: "recentLoadsCard",    x: 0,  y: 7, w: 12, h: 3 },           // Loads (last 7 days) widget on the right.

  // ───────── UTILIZATION ROW (2 rows tall, 1 tile) ─────────
  { id: "fleetUtilization",   x: 4,  y: 2, w: 4, h: 2 },           // Fleet utilization tile on its own row, wide enough to read.
